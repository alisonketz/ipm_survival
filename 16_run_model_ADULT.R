neonate_lowtag <- d_surv$lowtag[which(d_surv$left_age_e < 26)]

d_fit_neg <- d_fit_neg[!(d_fit_neg$lowtag %in% neonate_lowtag),]
d_fit_pos <- d_fit_pos[!(d_fit_pos$lowtag %in% neonate_lowtag),]
...
nimData <- list(
    ...
    y_fit_surv_neg = 1,
    fit_surv_neg_censored = d_fit_neg$censored,
    fit_surv_neg_sex = d_fit_neg$sex,
    fit_surv_neg_left = d_fit_neg$left_age,
    fit_surv_neg_right = d_fit_neg$right_age,
    fit_surv_neg_age2date = d_fit_neg$age2date,
    y_fit_surv_pos = 1,
    fit_surv_pos_censored = d_fit_pos$censored,
    fit_surv_pos_sex = d_fit_pos$sex,
